...
void OrdPrior::dispCont() {
    ...
    cout<<"-------------------------------"<<endl;
    cout<<"1) Sort Orders by Priority"<<endl;
    cout<<"2) Process Top Priority Order"<<endl;
    cout<<"3) Add Random Orders (Simulation)"<<endl;
    cout<<"4) Mark Guest as VIP"<<endl;
    cout<<"5) Show All VIP Guests"<<endl;
}
